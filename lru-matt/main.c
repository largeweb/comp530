...
void self_tests() {
    ...
    // We will ensure correct node count in the reference & clean methods

    printf("calling reference(i) from i 0...63\n");
    for (int i = 0; i < 64; i++) {
        rv = reference(i);
    ...
    printf("calling reference(i) from i 0...63 but i += 2\n");
    ...
    printf("calling print - should see 0..64 with evens having ref of 2\n");
    print();

    printf("calling clean(1)\n");
    clean(1);

    // Should see only evens
    printf("calling print - should only be even nums\n");
    print();

    printf("calling clean(0)\n");
    clean(0);

    // Should see an empty list
    printf("calling print - should be an empty list now\n");
    print(); 
    // printf("will test fgets now\n");
    // char line[256];
